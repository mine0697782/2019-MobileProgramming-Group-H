...
class MySQLIteOpenHelper(
    ...
    val d3 = arrayListOf(
        ...
        Element(1, 1, 1, "원두", 100, "g"),
        Element(1, 1, 2, "물", 50, "ml"),
        Element(1, 1, 3, "시간", 60, "sec"),
        Element(1, 2, 1, "원두", 110, "g"),
        Element(1, 2, 2, "물", 150, "ml"),
        Element(1, 2, 3, "시간", 60, "sec"),
        Element(1, 3, 1, "원두", 110, "g"),
        Element(1, 3, 2, "물", 50, "ml"),
        Element(1, 3, 3, "시간", 75, "sec"),
